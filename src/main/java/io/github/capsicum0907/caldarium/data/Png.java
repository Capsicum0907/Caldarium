 ...
 *
 * <p>Written out here rather than reached for from a library because everything this
 * mod draws is an array it computed itself. There is no file to decode, no format to
 * detect and no scaling to do, so a dependency able to do all three would only be a
 * dependency.
 */
